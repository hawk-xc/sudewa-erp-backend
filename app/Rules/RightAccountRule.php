...
class RightAccountRule implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        $account = Account::with('accountGroup')->find($value);
        ...
        if ($expectedCompanyId && (!$account->accountGroup || (int) $account->accountGroup->company_id !== (int) $expectedCompanyId)) {
